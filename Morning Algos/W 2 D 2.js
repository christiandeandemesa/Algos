...
for(var i=0; i<pokémon.length; i++) {
    if(pokémon[i].id > 99) {
        ...
        // Names of the pokemon who have an id greater than 99
    }
}
...
for(var i=0; i<pokémon.length; i++) {
    if(pokémon[i].id % 3 === 0) {
        console.log(pokémon[i].name);
        // Names of the pokemon whose id is evenly divisible by 3
    }
}
...
for(var i=0; i<pokémon.length; i++) {
    if(pokémon[i].types.length === 2) {
        console.log(pokémon[i].name);
        // Names of the pokemon that have more than one type
    }
}
...
for(var i=0; i<pokémon.length; i++) {
    if(pokémon[i].types.length === 1 && pokémon[i].types == "poison") {
        console.log(pokémon[i].name);
        // Names of the pokemon whose only type is "poison"
    }
}
